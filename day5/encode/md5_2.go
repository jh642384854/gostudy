...
/**
	MD5的全称是Message-DigestAlgorithm 5，它可以把一个任意长度的字节数组转换成一个定长的整数，并且这种转换是不可逆的。对于任意长度的数据，转换后的MD5值长度是固定的，
...
————————————————
版权声明：本文为CSDN博主「wade3015」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/wade3015/article/details/84454836
	原文链接：https://blog.csdn.net/wade3015/article/details/84454836
 */
func main() {
	strTest := "I love this beautiful world!" //这段字符串通过md5加密生成的32位小写字符就是下面的这段密文：98b4fc4538115c4980a8b859ff3d27e1
